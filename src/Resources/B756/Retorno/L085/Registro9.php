...
class Registro9 extends AbstractRegistroRetorno
{
    protected $meta = [
        ...
        'qtd_lotes' => ['tamanho' => 6, 'default' => '1', 'tipo' => 'int', 'required' => true],
        'qtd_registros' => ['tamanho' => 6, 'default' => '0', 'tipo' => 'int', 'required' => true],
        'qtd_contas' => ['tamanho' => 6, 'default' => '0', 'tipo' => 'int', 'required' => true],
        'filler3' => ['tamanho' => 205, 'default' => ' ', 'tipo' => 'alfa', 'required' => true],
    ];
}
