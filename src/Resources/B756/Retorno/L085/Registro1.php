...
class Registro1 extends AbstractRegistroRetorno
{
    protected $meta = [
        ...
        'operacao' => ['tamanho' => 1, 'default' => 'T', 'tipo' => 'alfa', 'required' => true],
        'tipo_servico' => ['tamanho' => 2, 'default' => '01', 'tipo' => 'int', 'required' => true],
        'filler1' => ['tamanho' => 2, 'default' => ' ', 'tipo' => 'int', 'required' => true],
        'versao_layout' => ['tamanho' => 3, 'default' => '044', 'tipo' => 'alfa', 'required' => true],
        'filler2' => ['tamanho' => 1, 'default' => '', 'tipo' => 'alfa', 'required' => true],
        'tipo_inscricao' => ['tamanho' => 1, 'default' => '', 'tipo' => 'int', 'required' => true],
        'numero_inscricao' => ['tamanho' => 15, 'default' => '', 'tipo' => 'int', 'required' => true],
        'codigo_beneficiario' => ['tamanho' => 20, 'default' => ' ', 'tipo' => 'alfa', 'required' => true],
        ...
        'mensagem_fixa1' => ['tamanho' => 40, 'default' => ' ', 'tipo' => 'alfa', 'required' => true],
        'mensagem_fixa2' => ['tamanho' => 40, 'default' => ' ', 'tipo' => 'alfa', 'required' => true],
        'numero_retorno' => ['tamanho' => 8, 'default' => '', 'tipo' => 'int', 'required' => true],
        'data_gravacao' => ['tamanho' => 8, 'default' => '', 'tipo' => 'date', 'required' => true],
        'data_credito' => ['tamanho' => 8, 'default' => '', 'tipo' => 'date', 'required' => true],
        'filler4' => ['tamanho' => 33, 'default' => ' ', 'tipo' => 'alfa', 'required' => true],
    ];
}
