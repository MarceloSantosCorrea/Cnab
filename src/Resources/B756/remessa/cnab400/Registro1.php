...
class Registro1 extends Generico1
{
    ...
    {
        $codigo_beneficiario = AbstractRemessa::$entryData['codigo_beneficiario'] . AbstractRemessa::$entryData['codigo_beneficiario_dv']; // NÃºmero do contrato: Ã o mesmo nÃºmero da conta
        $agencia = AbstractRemessa::$entryData['agencia']; // NÃºmero do contrato: Ã o mesmo nÃºmero da conta
